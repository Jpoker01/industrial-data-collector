...
This project features an IoT telemetry system utilizing MQTT and Modbus TCP data pipelines.
...
<img width="1536" height="1024" alt="System architecture diagram" src="https://github.com/user-attachments/assets/8169a8e7-c41a-4663-827c-2fb00bc5a4d2" />
## Architecture & Tech Stack
*   **Framework:** Django & Django REST Framework
*   **Databases:**
    *   **MongoDB 8:** Stores high-volume, time-series sensor telemetry.
    *   **PostgreSQL 18:** Stores relational metadata (users, sessions, device configurations).
*   **Protocols:**
...
The following instructions have to be explicitly followed to prevent any issues when launching the system.
...
Once the containers are up, the Django admin is available at `http://localhost:8000/admin/` using the superuser credentials from your `.env` file.
