...
def update_registers():
    ...
    while True:
        ...
        if reading is not None:
            ...
            store.setValues(3, 0, price_regs + [counter]) #3 = holding registers, 0 = starting adress
            logger.info("Registers updated: price=%s counter=%s",
                        reading["price"], counter)
...
def main():
    ...
    StartTcpServer(context=context, address=(LISTEN_HOST, LISTEN_PORT)) #main server that answers clients
